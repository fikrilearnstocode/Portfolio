...
export const projectAnalyses: ProjectAnalysis[] = [
  {
    projectId: "spotify-comprehensive",
    overview: [
      { label: "Tracks Analyzed", value: "3,069", icon: "🎵" },
      { label: "Analysis Techniques", value: "15+", icon: "🔬" },
      { label: "Models Compared", value: "10", icon: "🤖" },
      { label: "Best AUC (Top 50)", value: "0.82", icon: "🎯" },
    ],
    insights: [
      "Energy is the #1 predictor of chart success — confirmed by both Random Forest importance and SHAP values across all models.",
      "Acoustics negatively impacts chart performance: high-acoustic tracks rank significantly lower, showing Indonesian listeners prefer produced, high-energy sound.",
      "XGBoost wins both tasks — classification (AUC 0.82) and regression (R² 0.35) — outperforming LR, KNN, SVM, and Random Forest.",
      "ANOVA confirms audio features differ significantly across genres (p < 0.05); K-Pop and Pop dominate the top chart positions.",
      "t-SNE visualization reveals top-50 tracks form a loose but distinguishable cluster in audio feature space — energy and valence are key separators.",
      "Audio features explain ~35% of chart position variance — external factors (artist popularity, marketing) drive the remaining 65%.",
    ],
    charts: [
      {
        title: "Classification Model Comparison (Top 50 Prediction)",
        type: "bar",
        xKey: "model",
        data: [
          { model: "Logistic Reg", Accuracy: 72, F1: 65, AUC: 76 },
          { model: "KNN", Accuracy: 69, F1: 62, AUC: 72 },
          { model: "SVM", Accuracy: 74, F1: 67, AUC: 79 },
          { model: "Random Forest", Accuracy: 77, F1: 71, AUC: 80 },
          { model: "XGBoost", Accuracy: 79, F1: 74, AUC: 82 },
        ],
        dataKeys: [
      ...
      {
        title: "Regression Model Comparison (R² Score)",
        type: "bar",
        xKey: "model",
        data: [
          { model: "Linear Reg", r2: 0.18 },
          { model: "Ridge", r2: 0.18 },
          { model: "Lasso", r2: 0.16 },
          { model: "Random Forest", r2: 0.29 },
          { model: "XGBoost", r2: 0.35 },
        ],
        dataKeys: [{ key: "r2", color: "#b08f5a", name: "R² Score" }],
      },
      {
        ...
        xKey: "feature",
        data: [
          { feature: "energy", importance: 0.29 },
          { feature: "log_followers", importance: 0.21 },
          { feature: "valence", importance: 0.14 },
          { feature: "acoustics", importance: 0.11 },
          { feature: "tempo", importance: 0.08 },
          { feature: "danceability", importance: 0.07 },
          { feature: "speechiness", importance: 0.05 },
          { feature: "liveliness", importance: 0.05 },
        ],
        dataKeys: [{ key: "importance", color: "#b08f5a", name: "Mean |SHAP|" }],
      },
    ],
    methodology: [
