...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Regression model predicting house prices using XGBoost with extensive feature engineering. Covers missing value imputation, categorical encoding, and hyperparameter tuning. Top 20% on Kaggle leaderboard.",
